...
namespace VizualizerWPF
{
    ...
    public class Edge //: IEquatable<Edge>
    {
        ...
        public static double
            smallestCosOfAngle = 0.8; //cca 30 \degree we can take only smaller cos, maybe iterated one is needed
        ...
        /// <summary>
        ///     Function to detect, whether consectuive points <c>point1</c>, <c>point2</c>, <c>point3</c> are at angle less then
        ///     cca 30°
        /// </summary>
        ...
        {
            var first = point1 - point2;
            var second = point3 - point2;

            if (first * second / Math.Sqrt(first * first * (second * second)) <
                smallestCosOfAngle) //negative ones are alright
                return false;
            return true;
        }
